...
public class TestCases {
	...
	public void BoundaryTestInRightofLowerThresh(){
		...
		Runway run1 = new Runway("09L", 3902, 3902, 3902, 3595);
		run1.setObstacle(ob);
		assertEquals(3208, run1.getTORA());
		assertEquals(3208, run1.getTODA());
		assertEquals(3208, run1.getASDA());
		assertEquals(3595, run1.getLDA());
	}
	...
	public void BoundaryTestOnRightofLowerThresh(){
		...
		Runway run1 = new Runway("09L", 3902, 3902, 3902, 3595);
		run1.setObstacle(ob);
		assertEquals(3209, run1.getTORA());
		assertEquals(3209, run1.getTODA());
		assertEquals(3209, run1.getASDA());
		assertEquals(3595, run1.getLDA());
	}
	@Test
